        ...
        <>
            <div className="text-3xl text-richblack-50">Enrolled Courses</div>
            {
                ...
                !enrolledCourses ?
                    ...
                    // If no enrolledcourse is present
                    : !enrolledCourses.length ? (<p className="grid h-[10vh] w-full place-content-center text-richblack-5">You have not enrolled in any courses yet</p>) :
                        (
                            <div className="my-8 text-richblack-5">
                                ...
                                {/* Cards yaha se shuru hote hai */}
                                {
                                    enrolledCourses.map((course, index, arr) => {
                                        return (
                                            <div className={`flex items-center border border-richblack-700 ${index === arr.length - 1 ? "rounded-b-lg" : "rounded-none"
                                                }`}
                                                key={index}>
